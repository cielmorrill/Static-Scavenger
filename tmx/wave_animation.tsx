...
<tileset version="1.10" tiledversion="1.11.2" name="wave_animation" tilewidth="32" tileheight="32" tilecount="16" columns="4">
 <image source="wave_animation.png" width="128" height="128"/>
 <tile id="0">
  <animation>
